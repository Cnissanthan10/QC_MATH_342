...
##b_0 : This is coefficient that the intercept for the linear model and if the parent height were 0
##b_1 : It's the slope; Here children heights increases,when parents height increases by one unit.
##RMSE : RMSE is the variations of child's height and it is 2.238. 
##R^2 : R^2 is .21 which means 21.05% variation is explained here by the independent variables.
...
##"Children of short parents became longer on average and children of tall parents became shorter on average."
