...
As we include more predictors, the weights need to change in accordance with make the best fit straight model of the information. These weight esteems are not changeless, they are simply used to make the OLS fit line.
...
The coefficients for color did not change.
